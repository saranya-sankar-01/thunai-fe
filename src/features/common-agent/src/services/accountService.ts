...
const API_BASE =
  `${API_ENDPOINT}/account-service/ai/api/v1`;
...
export const fetchSchemaAttributes = async () => {
  ...
  // Extract attribute names from the response
  return response.data.attribute_mapping.map(attr => ({
